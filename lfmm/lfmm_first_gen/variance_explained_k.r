...
# ============================================================================
# Variance Explained Analysis for LFMM Model
# ============================================================================
#
# This script analyzes how much variance is explained by different numbers of 
# components (K) in the LFMM model to determine the optimal K value for the 
# subsequent analysis.
#
# Required Input Files:
# 1. /carnegie/nobackup/scratch/tbellagio/gea_grene-net/key_files/delta_p_maf05_mincount05_firstgensamples.csv
#    - Allele frequency data for the analysis
# 2. /carnegie/nobackup/scratch/tbellagio/gea_grene-net/lfmm_full/env_train_files/env_train_bio1.csv
#    - Environmental training data for bio1 (used as reference)
#
# Output Files:
# 1. /carnegie/nobackup/scratch/tbellagio/gea_grene-net/lfmm_full/lfmm_fullresults_all_k/variance_explained_k.csv
#    - CSV file containing variance explained for different K values
# 2. /carnegie/nobackup/scratch/tbellagio/gea_grene-net/lfmm_full/lfmm_fullresults_all_k/variance_explained_k.pdf
...
p <- ggplot(results_df, aes(x = K, y = Variance_Explained)) +
    ...
    labs(x = "Number of Components (K)",
         ...
         title = "Variance Explained by Different K Values")
