...
analysis_dir = '/carnegie/nobackup/scratch/tbellagio/gea_grene-net/lfmm_full_last_gen'

results_dir = '/carnegie/nobackup/scratch/tbellagio/gea_grene-net/lfmm_full_last_gen/lfmm_fullresults_all_k'
delta_p_file = '/carnegie/nobackup/scratch/tbellagio/gea_grene-net/key_files/delta_p_maf05_mincount05_lastgensamples.csv'
