...
posterior_df <- read.delim("data-intermediate/stabilizing_selection_leaveoneout_posterior_allruns_ecotypeprs.txt")
...
prediction_summary$source <- "stabilizing_prs"
...
write.table(prediction_summary,file = paste0("data-intermediate/Leave_one_out_prediction/stabilizing_selection_prs/",prefix,"stabilizing_selection_loo_p1_p0_prs_prediction_summary.txt"),
