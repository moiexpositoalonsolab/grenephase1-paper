...
"""
Launch WZA Analysis for GEMMA 231G Results

This script performs WZA (Weighted-Z Analysis) on GEMMA GWAS results from the 231G dataset.
...
Outputs:
1. Analysis Results:
   - gemma_231_wza_{biovar}.csv: WZA analysis results for each bioclimatic variable
...
for biovar in biovars:
    ...
    cmd = f'''python general_WZA_script_mod_polynomial_order7.py \\
        ...
        --summary_stat p_wald \\
        --window blocks \\
        --output gemma_231_wza_{biovar}.csv \\
        --sep ","'''
