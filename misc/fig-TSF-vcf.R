...
# Extract vcf
vcftools_command_locations <- paste0("vcftools --vcf data/greneNet_final_v1.1.recode.vcf --chr " ,chrom, " --from-bp ",start_bp," --to-bp ",end_bp ,
                                     " --recode --recode-INFO-all --out data-intermediate/subset_" , commonname )
cat(vcftools_command_locations)
