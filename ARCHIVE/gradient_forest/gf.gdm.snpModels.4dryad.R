...
pdf("/home/tbellagio/scratch/gea_grene-net/gradient_forest/plot.pdf")
plot(gfRef, plot.type=type)

#txtplot(gfRef, plot.type=type)

dev.off()
#system('open /home/tbellagio/scratch/gea_grene-net/gradient_forest/plot.pdf')
...
pdf("/home/tbellagio/scratch/gea_grene-net/gradient_forest/gfGI5.pdf")
plot(gfGI5, plot.type=type)
...
env_trns <- gfData[,3:13] 

# predRef <- predict(gfRef, envGF)
