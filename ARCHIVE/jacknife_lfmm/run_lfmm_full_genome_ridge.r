...
results_dir = sprintf('/carnegie/nobackup/scratch/tbellagio/gea_grene-net/jacknife_lfmm/split_number_%d', split_number)
...
output_af_bio12 = paste0(results_dir,'/delta_p/predicted_allele_freq_bio12.csv')

output_indices_bio1 = paste0(results_dir,'/delta_p/snps_indices_bio1.csv')
output_indices_bio12 = paste0(results_dir,'/delta_p/snps_indices_bio12.csv')
