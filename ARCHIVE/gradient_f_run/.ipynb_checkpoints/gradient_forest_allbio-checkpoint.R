...
model_filename <- paste0(split_dir, "gf_model_split_", split_num, ".rds")
...
natural_filename_csv <- paste0(split_dir, "natural_trans_split_", split_num, ".csv")
garden_filename_csv <- paste0(split_dir, "garden_trans_split_", split_num, ".csv")
offsets_filename_csv <- paste0(split_dir, "offsets_split_", split_num, ".csv")
