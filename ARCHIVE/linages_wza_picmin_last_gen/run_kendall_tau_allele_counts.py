...
af = pd.read_csv('../key_files/allele_counts_maf05_mincount05_firstgensamples.csv', usecols = samples_run)
...
kendall.to_csv(f'kendall_allele_counts_{run}.csv',index=False)