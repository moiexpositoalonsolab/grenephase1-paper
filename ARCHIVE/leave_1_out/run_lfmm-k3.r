...
################## change all teh naems to be _k3
file_name <- basename(path_ldp_af)
output_file_pvalue <- paste0(results_dir, "/pvalues_k3.csv")
output_file_zscores <- paste0(results_dir, "/zscores_k3.csv")
output_file_gif <- paste0(results_dir, "/gif_k3.csv")
output_file_qvalue = paste0(results_dir, "/qvalues_k3.csv")
