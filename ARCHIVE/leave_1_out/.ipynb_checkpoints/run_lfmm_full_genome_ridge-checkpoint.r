...
### create output files 
output_file_wo_calibration_pvalue <- paste0(results_dir, "/delta_p_filt/wo_calibration_pvalue_full_genome.csv")
output_file_w_calibration_pvalue <- paste0(results_dir, "/delta_p_filt/w_calibration_pvalue_full_genome.csv")

output_file_effect_sizes_simple <- paste0(results_dir, "/delta_p_filt/effect_sizes_simple_full_genome.csv")

output_file_w_calibration_qvalue = paste0(results_dir, "/delta_p_filt/w_calibration_qvalue_full_genome.csv")
output_file_wo_calibration_qvalue = paste0(results_dir, "/delta_p_filt/wo_calibration_qvalue_full_genome.csv")

output_af_bio1 = paste0(results_dir,'/delta_p_filt/predicted_allele_freq_bio1.csv')
output_af_bio12 = paste0(results_dir,'/delta_p_filt/predicted_allele_freq_bio12.csv')

output_indices_bio1 = paste0(results_dir,'/delta_p_filt/snps_indices_bio1.csv')
output_indices_bio12 = paste0(results_dir,'/delta_p_filt/snps_indices_bio12.csv')
