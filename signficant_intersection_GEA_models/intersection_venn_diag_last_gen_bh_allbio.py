...
"""
Analyze Intersections Between Different Models (All Bioclimatic Variables)

This script analyzes the overlap between significant genomic blocks identified by different models
across all bioclimatic variables in the last generation of the study. It includes additional models
like GEMMA and performs statistical tests to assess the significance of overlaps.
...
2. Output Files:
   ...
   - Venn diagrams showing overlaps between models for each bioclimatic variable
"""
...
if __name__ == "__main__":
    # List of bioclimatic variables to process
    bioclim_vars = ['bio1', 'bio2', 'bio3', 'bio4', 'bio5', 'bio6', 'bio7', 'bio8', 'bio9', 'bio10', 
                    'bio11', 'bio12', 'bio13', 'bio14', 'bio15', 'bio16', 'bio17', 'bio18', 'bio19']
    
    # Process each bioclimatic variable
    for biovar in bioclim_vars:
        print(f"\nProcessing {biovar}...")
        ...
        print(f"Analysis complete for {biovar}. Results saved in venn_diagram_last_gen_{biovar}.png/pdf")
...
"""
Analyze Intersections Between Different Models Across All Bioclimatic Variables
...
Script Outline:
1. Load and process results from different models for each bioclimatic variable
...
6. Generate visualizations for each bioclimatic variable
"""
...
if __name__ == "__main__":
    # List of bioclimatic variables to process
    bioclimatic_vars = ['bio1', 'bio2', 'bio3', 'bio4', 'bio5', 'bio6', 'bio7', 'bio8', 'bio9', 'bio10', 
                        'bio11', 'bio12', 'bio13', 'bio14', 'bio15', 'bio16', 'bio17', 'bio18', 'bio19']
    
    # Process results for each bioclimatic variable
    for biovar in bioclimatic_vars:
        print(f"\nProcessing {biovar}...")
        sign_wza_gemma, sign_wza_lfmm, sign_wza_kendall, sign_binomial_reg = process_model_results(biovar)
...
"""
Analyze Intersections Between Different Models (Last Generation) for All Bioclimatic Variables

This script analyzes the overlap between significant genomic blocks identified by different models
in the last generation across all bioclimatic variables. It generates a grid of Venn diagrams
showing the overlaps for each variable and performs statistical tests.

Required Files:
1. Input Files:
   - ../key_files/blocks_snpsid_dict.pkl: Dictionary mapping SNP IDs to block IDs
   - ../wza_last_gen/gemma_1001_wza_{biovar}.csv: GEMMA model results
   - ../wza_last_gen/wza_results_lfmm_{biovar}_poly7.csv: LFMM model results
   - ../wza_last_gen/wza_kendalltau_results_{biovar}_poly7.csv: Kendall Tau model results
   - ../wza_last_gen/wza_binomial_regression_{biovar}_poly7.csv: Binomial regression model results

2. Output Files:
   - overlap_gea_gemma_last_gen.png/pdf: Grid of Venn diagrams for all bioclimatic variables
...
2. Apply multiple testing correction (BH)
3. Identify significant blocks
4. Generate grid of Venn diagrams
5. Perform statistical tests on overlaps
"""
...
biovars = [
    'bio1', 'bio7', 'bio13', 'bio14', 'bio4', 'bio10', 'bio17', 'bio9',
    'bio3', 'bio15', 'bio12', 'bio18', 'bio6', 'bio2', 'bio8', 'bio16',
    'bio11', 'bio5'
]
...
def generate_venn_grid():
    """
    Generate a grid of Venn diagrams for all bioclimatic variables.
    """
    # Set up the grid
    ...
    colors = ['blue', 'green', 'lightgreen', 'darkgreen']
...
# --- Main Execution ---
if __name__ == "__main__":
    print("Generating Venn diagrams for all bioclimatic variables...")
    generate_venn_grid()
    print("Analysis complete. Results saved in overlap_gea_gemma_last_gen.png/pdf")
